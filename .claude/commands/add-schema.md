...
2. Create `packages/contracts/src/$ARGUMENTS.ts` with Zod schema + inferred type export
3. Add to barrel export `packages/contracts/src/index.ts`
4. Create `packages/contracts/src/$ARGUMENTS.test.ts` with validation tests
